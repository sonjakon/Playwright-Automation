...
test('login into existing account - "Log out" button should be visible in the header', async ({ page }) => {
    ...
    await test.step("login to Dzobs", async () => {
        ...
        await page.getByPlaceholder('Email').fill('sonjatests@blonmail.com');
